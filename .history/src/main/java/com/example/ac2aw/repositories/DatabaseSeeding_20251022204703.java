...
public class DatabaseSeeding implements CommandLineRunner {
   ...
   public void run(String... args) throws Exception {
      // Clear existing data to ensure idempotent seeding (optional, but good for
      // testing)
      // Note: You might need to adjust the order or use TRUNCATE for production-like
      // scenarios
      // For simplicity, we'll rely on the database dropping/recreating based on
