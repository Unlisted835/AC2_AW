...
public class ProjetoServiceImpl implements ProjetoService {
   ...
   public Projeto findByIdIncludingFuncionarios(int id) {
      ...
      throw new UnsupportedOperationException("Unimplemented method 'findByIdIncludingFuncionarios'");
   }

   @Override
   public List<Projeto> findAllInsideDuringPeriod(LocalDate dataInicio, LocalDate dataFim) {
      // TODO Auto-generated method stub
      throw new UnsupportedOperationException("Unimplemented method 'findAllInsideDuringPeriod'");
   }
