...
public class FuncionarioController {
   ...
   public FuncionarioDTO salvarFuncionario(@RequestBody FuncionarioCreateDTO dto) {
   ...
   @PutMapping("{id}")
   public void editarFuncionario(@PathVariable Long id, @RequestBody FuncionarioDTO dto) {
